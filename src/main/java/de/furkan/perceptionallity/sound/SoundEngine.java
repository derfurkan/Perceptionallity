...
public class SoundEngine {
  ...
  /**
   * Plays the specified sound with the given volume and looping preference.
   * A new SoundThread is created and started for the sound, and the sound is added to the soundThreads map.
   *
  ...
  /**
   * Stops all currently playing sounds and closes their associated SourceDataLines.
   * This method iterates through all entries in the soundThreads map, stopping and closing each one.
   */
  ...
  /**
   * Sets the volume for all currently playing sounds to the specified level.
   * This method iterates through all sound threads and applies the new volume setting to each.
   *
  ...
  /**
   * Sets the volume of a specific sound if it is currently being played.
   * Throws a RuntimeException if the sound is not found in the currently playing sound threads.
   *
