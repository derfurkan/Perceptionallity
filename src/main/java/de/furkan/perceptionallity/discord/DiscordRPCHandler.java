...
public class DiscordRPCHandler {
    ...
    public void initializeRPC() throws Exception {
        if(discordCore != null) {
            game.getLogger().warning("Discord core has already been initialized. Please close it first before initializing it again.");
            return;
        }
        ...
        currentActivity.assets().setLargeImage("main2");
