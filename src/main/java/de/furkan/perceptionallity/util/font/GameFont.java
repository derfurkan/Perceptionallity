...
public class GameFont {
  ...
  /**
   * Constructs a GameFont object by loading a font from the specified file path.
   * The font is loaded using the Font.createFont method, which throws an exception if the font cannot be loaded.
   *
