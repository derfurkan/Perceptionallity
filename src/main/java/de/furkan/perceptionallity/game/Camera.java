...
public class Camera {
    ...
    public boolean isComponentInView(Component component) {

        Rectangle cameraView =
                new Rectangle(
                        getCameraViewLocation().getX(),
                        getCameraViewLocation().getY(),
                        Perceptionallity.getGame().getWINDOW_WIDTH(),
                        Perceptionallity.getGame().getWINDOW_HEIGHT());

        Rectangle componentBounds = component.getBounds();

        return cameraView.intersects(componentBounds);
    }
